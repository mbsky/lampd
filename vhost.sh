...
do
	echo
	read -p "Please input domain(example: www.myxnova.com): " domain
...
if [ "$moredomainame_yn" == 'y' ]; then
        ...
        do
                echo
                read -p "Type domainname,example(myxnova.com www.example.com): " moredomain
...
# For more information please visit http://blog.myxnova.com/82.html  #
#######################################################################
"
echo -e "`printf "%-32s" "Your domain:"`\033[32m$domain\033[0m"
