...
#
# Version: 0.81 2015-01-21 a950216t AT gmail.com
...
# check Customized Language
while :
do
        echo
        read -p "Please input your location [1=Taiwan 2=Hong Kong 3=Macao 4=China 5=English]: " location_1234
        if [ "$location_1234" != '1' -a "$location_1234" != '2' -a "$location_1234" != '3' -a "$location_1234" != '4' ];then
                echo -e "\033[31minput error! Please only input '1' or '2' or '3' or '4'\033[0m"
        else
		if [ "$location_1234" == '1' ];then
				echo -e "\033[31mYou choose:1.Taiwan\033[0m"
		        sed -i "s@^location_1234.*@location_1234=TW@" ./options.conf && break
		elif [ "$location_1234" == '2' ];then
				echo -e "\033[31mYou choose:2.Hong Kong\033[0m"
		        sed -i "s@^location_1234.*@location_1234=HK@" ./options.conf && break
		elif [ "$location_1234" == '3' ];then
				echo -e "\033[31mYou choose:3.Macao\033[0m"
		        sed -i "s@^location_1234.*@location_1234=MO@" ./options.conf && break
		elif [ "$location_1234" == '4' ];then
				echo -e "\033[31mYou choose:4.China\033[0m"
		        sed -i "s@^location_1234.*@location_1234=CN@" ./options.conf && break
		elif [ "$location_1234" == '5' ];then
				echo -e "\033[31mYou choose:5.English\033[0m"
				sed -i "s@^location_1234.*@location_1234=EN@" ./options.conf && break
		else
				echo -e "\033[31mError!\033[0m" && break
		fi
                break
        fi
done
