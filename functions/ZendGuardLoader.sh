...
if [ `getconf WORD_BIT` == 32 ] && [ `getconf LONG_BIT` == 64 ] ;then
	if [ "$PHP_version" == '5.4' ];then
		src_url=http://lampd.googlecode.com/svn/src/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-x86_64.tar.gz && Download_src
	...
	if [ "$PHP_version" == '5.3' ];then
		src_url=http://lampd.googlecode.com/svn/src/ZendGuardLoader-php-5.3-linux-glibc23-x86_64.tar.gz && Download_src
        ...
        if [ "$PHP_version" == '5.4' ];then
		src_url=http://lampd.googlecode.com/svn/src/ZendGuardLoader-70429-PHP-5.4-linux-glibc23-i386.tar.gz && Download_src
        ...
        if [ "$PHP_version" == '5.3' ];then
		src_url=http://lampd.googlecode.com/svn/src/ZendGuardLoader-php-5.3-linux-glibc23-i386.tar.gz && Download_src
